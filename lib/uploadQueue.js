...
// bucket under its own prefix: a small JSON metadata file (imdbId, filename,
...
/**
 * @param {object} entry
 * @param {string} entry.imdbId - e.g. "tt1234567"
 ...
 */
async function add({ imdbId, originalFilename, translatedSrt, lineCount, note }) {
