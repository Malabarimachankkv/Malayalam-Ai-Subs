...
// "00:05:23,456 --> 00:05:26,000" -> 323.456 (seconds)
function startSeconds(entry) {
  const start = entry.timing.split("-->")[0].trim();
...
module.exports = { parseSrt, buildSrt, startSeconds };
